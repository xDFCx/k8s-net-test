...
do 
    ...
    test_connection host-network-headless.net-test.svc.cluster.local
    test_connection pod-network-headless.net-test.svc.cluster.local
    
    # Checks that we can connect to the pods via the service (ClusterIP)
    # (i.e. validates that kube-proxy is working)
    test_connection host-network.net-test.svc.cluster.local
    test_connection pod-network.net-test.svc.cluster.local
